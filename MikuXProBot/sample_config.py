...
class Config(object):
    ...
    OWNER_ID = 5077976227 # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "awoo"
    SUPPORT_CHAT = 'SHUKURENAI_SUPPORT'  #Your own group for support, do not add the @

...
from MikuXProBot import DEMONS, DRAGONS, dispatcher, pgram as bot
...
HODAKA = ( "https://telegra.ph/file/401973482ba376ac53d88.jpg", "https://telegra.ph/file/4db74f3119e62909973aa.jpg", )
...
def goodnight(update: Update, context: CallbackContext):
    ...
    message.reply_photo(random.choice(HODAKA),caption=reply, parse_mode=ParseMode.MARKDOWN)

MIKU = ( "https://telegra.ph/file/292c3e9d8e9649f75059e.jpg", "https://telegra.ph/file/946190dda5c3e24c6ffc3.jpg", )
...
def goodmorning(update: Update, context: CallbackContext):
    ...
    message.reply_photo(random.choice(MIKU),caption=reply, parse_mode=ParseMode.MARKDOWN)
...
def waifu(update: Update, context: CallbackContext):
    message = update.effective_message
    message.reply_photo(random.choice(fun_strings.WAIFUS_IMG), caption= "*A waifu appeared!* \nAdd them to your harem by sending /protecc character name", parse_mode=ParseMode.MARKDOWN)

@run_async
def harem(update: Update, context: CallbackContext):
    update.effective_message.reply_text("You haven't protecc'd any waifu yet...")

@run_async
def protecc(update: Update, context: CallbackContext):
    update.effective_message.reply_text("OwO you protecc'd A Waifu This waifu has been added to your harem.")

MIKU_ID = ( "https://telegra.ph/file/b9ca40cab2f66ef2d2960.mp4",
        "https://telegra.ph/file/e9d7ca05f178b48cd8520.mp4",
        "https://telegra.ph/file/e9d7ca05f178b48cd8520.mp4",
        "https://telegra.ph/file/551010bf35e75c3055728.mp4",
        "https://telegra.ph/file/3dd5d4404f4503e8e58e4.mp4", )
...
def gbam(update, context):
    ...
    if int(user.id) in DRAGONS or int(user.id) in DEMONS:
        ...
        context.bot.sendMessage(chat.id, gbam, parse_mode=ParseMode.MARKDOWN)
...
def decide(update: Update, context: CallbackContext):
    reply_animation = update.effective_message
    bot.send_video(reply_animation.chat.id , random.choice(MIKU_ID) , caption=random.choice(fun_strings.DECIDE))
...
WAIFUS_HANDLER = DisableAbleCommandHandler("waifu", waifu)
PROTECC_HANDLER = DisableAbleCommandHandler("protecc", protecc)
HAREM_HANDLER = DisableAbleCommandHandler("harem", harem)
